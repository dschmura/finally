  ...
  set :application,     "finally"
  set :repo_url,        "git@github.com:dschmura/finally.git"
  set :user,            'deployer'
  ...
  set :deploy_to,       "/home/#{fetch(:user)}/apps/finally"
  set :puma_bind,       "unix://#{shared_path}/tmp/sockets/finally-puma.sock"
  ...
  namespace :deploy do
    ...
    #       execute("ln -nfs /home/deployer/apps/finally/current/config/nginx.conf /etc/nginx/sites-enabled/finally && rm /etc/nginx/sites-enabled/default")
    #     end
    #   end
    # end
